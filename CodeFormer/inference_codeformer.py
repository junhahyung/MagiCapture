...
def Codeformer_img(
    ...
    ckpt_path = load_file_from_url(url=pretrain_model_url['restoration'], 
                                    model_dir='CodeFormer/weights/CodeFormer', progress=True, file_name=None)
    ...
    for i, img_path in enumerate(input_img_list):
        ...
        img_name = os.path.basename("temp")
        ...
        if has_aligned: 
            ...
            #cv2.imwrite('test_cv2img.jpg', face_helper.input_img)
